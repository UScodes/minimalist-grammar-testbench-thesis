...
parse_to_gen_generation_case(32, [drei,hundert,sieben,und,vier,zig], parse_fail, none, generation_not_attempted, [], [], '').
parse_to_gen_generation_case(33, ['Schinken'], parse_fail, none, generation_not_attempted, [], [], '').
parse_to_gen_generation_case(34, [und], parse_fail, none, generation_not_attempted, [], [], '').
parse_to_gen_generation_case(35, [zig], parse_fail, none, generation_not_attempted, [], [], '').
parse_to_gen_generation_case(36, [hundert,hundert], parse_fail, none, generation_not_attempted, [], [], '').
