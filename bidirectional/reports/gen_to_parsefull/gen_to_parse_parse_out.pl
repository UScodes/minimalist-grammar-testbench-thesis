...
gen_to_parse_parsing_case(53, '0X+80'(8), ok, [eight,y], [eight,y], ok, '0X+80'(8)).
gen_to_parse_parsing_case(54, '1X+40'(4), gen_empty_yield, [], [], parse_skipped_empty_tokens, none).
gen_to_parse_parsing_case(55, '1X+60'(4), gen_empty_yield, [], [], parse_skipped_empty_tokens, none).
gen_to_parse_parsing_case(56, '1X+70'(4), gen_empty_yield, [], [], parse_skipped_empty_tokens, none).
gen_to_parse_parsing_case(57, '1X+80'(4), gen_empty_yield, [], [], parse_skipped_empty_tokens, none).
gen_to_parse_parsing_case(58, '1X+90'(4), gen_empty_yield, [], [], parse_skipped_empty_tokens, none).
gen_to_parse_parsing_case(59, '1X+100Y'(1,20), ok, [one,hundred_and,twenty], [one,hundred_and,twenty_], parse_fail, none).
gen_to_parse_parsing_case(60, '1X+100Y'(2,30), ok, [two,hundred_and,thirty], [two,hundred_and,thirty_], parse_fail, none).
gen_to_parse_parsing_case(61, '1X+100Y'(3,'1X+20'(4)), ok, [three,hundred_and,twenty,four], [three,hundred_and,twenty_,four], parse_fail, none).
gen_to_parse_parsing_case(62, '1X+100Y'(5,'1X+30'(6)), ok, [five,hundred_and,thirty,six], [five,hundred_and,thirty_,six], parse_fail, none).
gen_to_parse_parsing_case(63, '1X+20'(4), ok, [twenty,four], [twenty_,four], ok, '1X+20'(4)).
