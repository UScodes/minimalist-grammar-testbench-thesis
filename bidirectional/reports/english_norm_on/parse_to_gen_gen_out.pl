...
parse_to_gen_generation_case(1, [twenty_,one], ok, '1X+20'(1), ok, [twenty,one], [twenty_,one], twentyone).
parse_to_gen_generation_case(2, [twenty_,four], ok, '1X+20'(4), ok, [twenty,four], [twenty_,four], twentyfour).
parse_to_gen_generation_case(3, [twenty_,seven], ok, '1X+20'(7), ok, [twenty,seven], [twenty_,seven], twentyseven).
parse_to_gen_generation_case(4, [thirty_,four], ok, '1X+30'(4), ok, [thirty,four], [thirty_,four], thirtyfour).
parse_to_gen_generation_case(5, [fifty_,six], ok, '1X+50'(6), ok, [fifty,six], [fifty_,six], fiftysix).
