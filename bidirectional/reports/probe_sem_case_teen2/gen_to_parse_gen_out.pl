...
gen_to_parse_generation_case(2, '1X+10'(4), ok, [four,teen], fourteen).
gen_to_parse_generation_case(3, '1X+10'(6), ok, [six,teen], sixteen).
gen_to_parse_generation_case(4, '1X+10'(7), ok, [seven,teen], seventeen).
gen_to_parse_generation_case(5, '1X+10'(9), ok, [nine,teen], nineteen).
gen_to_parse_generation_case(6, '0X+18'(8), ok, [eight,een], eighteen).
