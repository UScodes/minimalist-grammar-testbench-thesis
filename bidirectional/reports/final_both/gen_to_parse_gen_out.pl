...
gen_to_parse_generation_case(27, '1X+20'(3), ok, [undzwanzig,drei], undzwanzigdrei).
gen_to_parse_generation_case(28, '10X'(4), ok, [zig,vier], zigvier).
gen_to_parse_generation_case(29, '1X+10'(3), ok, [zehn,drei], zehndrei).
gen_to_parse_generation_case(30, '100X'(3), ok, [hundert,drei], hundertdrei).
gen_to_parse_generation_case(31, '1X+60'(2), ok, [zwei,undsechzig], zweiundsechzig).
gen_to_parse_generation_case(32, '1X+70'(2), ok, [zwei,undsiebzig], zweiundsiebzig).
gen_to_parse_generation_case(33, '1X+100Y'(3,4), generation_timeout, [], '').
gen_to_parse_generation_case(34, '1X+1Y'(2,4), generation_timeout, [], '').
gen_to_parse_generation_case(35, 'UNKNOWN_GERMAN_SEM'(4), gen_empty_yield, [], '').
gen_to_parse_generation_case(36, '1X+999'(3), gen_empty_yield, [], '').
