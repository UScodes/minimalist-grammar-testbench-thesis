...
gen_to_parse_parsing_case(2, '1X+20'(4), ok, [twenty,four], [twenty_,four], ok, '1X+20'(4)).
gen_to_parse_parsing_case(3, '1X+20'(7), ok, [twenty,seven], [twenty_,seven], ok, '1X+20'(7)).
gen_to_parse_parsing_case(4, '1X+30'(4), ok, [thirty,four], [thirty_,four], ok, '1X+30'(4)).
gen_to_parse_parsing_case(5, '1X+50'(6), ok, [fifty,six], [fifty_,six], ok, '1X+50'(6)).
