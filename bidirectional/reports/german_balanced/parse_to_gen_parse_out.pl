...
parse_to_gen_parsing_case(26, [drei,undzwanzig], ok, '1X+20'(3)).
parse_to_gen_parsing_case(27, [vier,zig], ok, '10X'(4)).
parse_to_gen_parsing_case(28, [drei,hundert], ok, '100X'(3)).
parse_to_gen_parsing_case(29, [sieben,und,vier,zig], ok, '1X+1Y'('10X+N'(4),7)).
parse_to_gen_parsing_case(30, [drei,hundert,vier], ok, '1X+100Y'(4,3)).
parse_to_gen_parsing_case(31, [sieben,und,acht,zig], parse_fail, none).
parse_to_gen_parsing_case(32, [drei,hundert,sieben,und,vier,zig], parse_fail, none).
parse_to_gen_parsing_case(33, ['Schinken'], parse_fail, none).
parse_to_gen_parsing_case(34, [und], parse_fail, none).
parse_to_gen_parsing_case(35, [zig], parse_fail, none).
parse_to_gen_parsing_case(36, [hundert,hundert], parse_fail, none).
