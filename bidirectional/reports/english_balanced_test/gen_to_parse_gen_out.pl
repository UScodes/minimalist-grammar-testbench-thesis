...
gen_to_parse_generation_case(53, '10X'(9), ok, [nine,ty], ninety).
gen_to_parse_generation_case(54, '0X+80'(8), ok, [eight,y], eighty).
gen_to_parse_generation_case(55, '1X+40'(4), gen_empty_yield, [], '').
gen_to_parse_generation_case(56, '1X+60'(4), gen_empty_yield, [], '').
gen_to_parse_generation_case(57, '1X+70'(4), gen_empty_yield, [], '').
gen_to_parse_generation_case(58, '1X+80'(4), gen_empty_yield, [], '').
gen_to_parse_generation_case(59, '1X+90'(4), gen_empty_yield, [], '').
gen_to_parse_generation_case(60, '1X+100Y'(1,20), ok, [one,hundred_and,twenty], onehundred_andtwenty).
gen_to_parse_generation_case(61, '1X+100Y'(2,30), ok, [two,hundred_and,thirty], twohundred_andthirty).
gen_to_parse_generation_case(62, '1X+100Y'(3,'1X+20'(4)), ok, [three,hundred_and,twenty,four], threehundred_andtwentyfour).
gen_to_parse_generation_case(63, '1X+100Y'(5,'1X+30'(6)), ok, [five,hundred_and,thirty,six], fivehundred_andthirtysix).
