...
parse_to_gen_parsing_case(14, [zwei,undzwanzig], ok, '1X+20'(2)).
parse_to_gen_parsing_case(15, [sechs,undzwanzig], ok, '1X+20'(6)).
parse_to_gen_parsing_case(16, [sieben,undzwanzig], ok, '1X+20'(7)).
