...
parse_to_gen_generation_case(14, [zwei,undzwanzig], ok, '1X+20'(2), ok, [zwei,undzwanzig], [zwei,undzwanzig], zweiundzwanzig).
parse_to_gen_generation_case(15, [sechs,undzwanzig], ok, '1X+20'(6), ok, [sechs,undzwanzig], [sechs,undzwanzig], sechsundzwanzig).
parse_to_gen_generation_case(16, [sieben,undzwanzig], ok, '1X+20'(7), ok, [sieben,undzwanzig], [sieben,undzwanzig], siebenundzwanzig).
