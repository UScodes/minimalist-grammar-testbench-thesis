...
gen_to_parse_parsing_case(1, '1X+20'(4), ok, [twenty,four], [twenty_,four], ok, '1X+20'(4)).
gen_to_parse_parsing_case(2, '1X+20'(15), generation_timeout, [], [], parse_skipped_empty_tokens, none).
gen_to_parse_parsing_case(3, 'UNKNOWN_SEM'(4), gen_empty_yield, [], [], parse_skipped_empty_tokens, none).
